  ...
  return (
    <div className="min-h-dvh bg-background">
      <div className="flex min-h-dvh">
        <aside
          className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-white/8 bg-black/70 p-4 backdrop-blur-xl transition-transform duration-200 lg:static lg:translate-x-0 ${
        ...
        >
          ...
          <Link
            href="/"
            onClick={() => setOpen(false)}
            className="mt-4 flex items-center gap-2 rounded-xl border border-white/10 px-3 py-2 font-mono text-[11px] uppercase tracking-[0.16em] text-zinc-300 transition-colors duration-200 hover:bg-white/[0.04] hover:text-foreground"
          >
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-30 flex items-center justify-between border-b border-white/8 bg-black/50 px-4 py-3 backdrop-blur-xl">
            <button
              type="button"
